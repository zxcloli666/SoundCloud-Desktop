...
export const PlaylistCard = React.memo(
  function PlaylistCard({ playlist, showPlayback, className }: PlaylistCardProps) {
    ...
    return (
      <div
        className={`group relative flex flex-col gap-3 cursor-pointer select-none${className ? ` ${className}` : ''}`}
