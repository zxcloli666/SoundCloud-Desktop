...
const LibraryBase = () => {
    ...
    // Data Fetching
    const { data: likedTracksData, isLoading: likesLoading } =
        useLikedTracks(200)
    const { data: followingsData, isLoading: followingsLoading } =
        useMyFollowings(50)
    const { data: likedPlaylistsData, isLoading: likedPlaylistsLoading } =
        useMyLikedPlaylists(50)
    const { data: myPlaylists, isLoading: myPlaylistsLoading } =
        useMyPlaylists()
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-white/50 font-medium mt-1">
                            {toCompactCount(user.public_favorites_count)}{' '}
                            {t('search.tracks').toLowerCase()}
                        </p>
                    </div>
            ...
            <div className="min-h-[400px]">
                ...
                {activeTab === 'playlists' && (
                    <div className="space-y-10 animate-fade-in-up">
                        ...
                        ) : Array.isArray(createdPlaylists) &&
